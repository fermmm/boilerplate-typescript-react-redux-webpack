...
- **Redux**
- **React-Router**
- **TSLint rules coded by me and a configuration that bans: "object", "any" and other practices that lazy js devs use when they don't fully understand the benefits of a typed language**
