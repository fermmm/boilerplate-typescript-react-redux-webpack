...
// Dispatcher creators:
export const changeHelloText: DispatcherCreator<string> = 
   (payload: string) => ({type: CHANGE_HELLO_TEXT, payload});

export const changeHelloNumber: DispatcherCreator<number> = 
   (payload: number) => ({type: CHANGE_HELLO_NUMBER, payload});
